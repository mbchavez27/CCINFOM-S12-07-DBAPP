...
export const addLatePenalty = async (borrow_id, customer_id, date_imposed) => {
  try {
    const [result] = await db.query(
      'INSERT INTO penalties (borrow_id, customer_id, ticket_id, date_imposed) VALUES (?, ?, NULL, ?)',
      [borrow_id, customer_id, date_imposed]
    )
